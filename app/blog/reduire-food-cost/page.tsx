...
export const metadata: Metadata = {
  ...
  description:
    "Le coût matière est l'indicateur clé de rentabilité en restauration. Découvrez 8 méthodes concrètes pour le réduire sans sacrifier la qualité.",
};
        ...
        <div className="max-w-[720px] mx-auto px-6 md:px-12">
          <ScrollReveal>
            ...
            <h1 className="font-serif text-3xl md:text-4xl font-semibold leading-tight tracking-tight mb-6">
              Comment réduire son coût matière en restauration
            </h1>
            <p className="text-lg text-[#6A6059] leading-relaxed mb-10">
              Le coût matière est l&apos;un des indicateurs les plus importants en restauration.
              Il représente le pourcentage de votre chiffre d&apos;affaires consacré aux matières
              premières. Un coût matière mal maîtrisé, c&apos;est de la marge qui disparaît chaque
          ...
          <ScrollReveal delay={0.1}>
            <div className="prose prose-lg max-w-none">
              <h2 className="font-serif text-2xl font-semibold mt-10 mb-4">Qu&apos;est-ce que le coût matière ?</h2>
              <p className="text-[15px] text-[#6A6059] leading-relaxed mb-4">
                Le coût matière se calcule simplement : <strong className="text-[#1a1a18]">coût des matières premières ÷ chiffre d&apos;affaires × 100</strong>.
                En France, un coût matière moyen en restauration traditionnelle se situe entre 25% et 35%.
              ...
              <p className="text-[15px] text-[#6A6059] leading-relaxed mb-4">
                ...
                Pauco calcule automatiquement le coût matière par plat et vous suggère un prix de vente adapté.
              </p>
              ...
              <p className="text-[15px] text-[#6A6059] leading-relaxed mb-4">
                ...
                de la veille, c&apos;est du coût matière récupéré.
              </p>
              ...
              <p className="text-[15px] text-[#6A6059] leading-relaxed mb-4">
                ...
                être intégrées dans votre coût matière. Pauco les calcule automatiquement dans
                les fiches cocktails et recettes.
              </p>

              <h2 className="font-serif text-2xl font-semibold mt-10 mb-4">7. Suivez votre coût matière quotidiennement</h2>
              <p className="text-[15px] text-[#6A6059] leading-relaxed mb-4">
                Un coût matière qui dérive de 2% pendant un mois sans que vous le remarquiez,
              ...
              <p className="text-[15px] text-[#6A6059] leading-relaxed mb-6">
                Excel n&apos;est pas un outil de gestion de coût matière. Vous avez besoin d&apos;un outil
              ...
              <div className="bg-[#D6F0DF] border border-[#6DBF85]/30 rounded-xl p-6 my-10">
                <p className="text-sm text-[#2D6A4A] leading-relaxed">
                  <strong>Pauco calcule votre coût matière automatiquement</strong> — par plat, par cocktail,

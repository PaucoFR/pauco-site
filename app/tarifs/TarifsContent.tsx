...
const faqs = [
  {
    ...
    a: "Oui, c'est un engagement contractuel. Tant que vous restez abonné, votre prix ne changera jamais — même quand le logiciel passera à 249€ pour les nouveaux clients.",
  },
  {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <ScrollReveal className="overflow-visible pt-3">
              <div className="bg-white border-2 border-[#2D6A4A] rounded-xl p-7 relative overflow-visible">
                ...
                <ul className="space-y-3 mb-8">
                  {[
                    "8 modules actifs dès maintenant",
            ...
            <ScrollReveal delay={0.15}>
              <div className="bg-white border border-[#E4DDD3] rounded-xl p-7">
                ...
                <div className="flex items-baseline gap-1 mb-1">
                  <span className="font-serif text-5xl font-semibold text-[#A09488]">249€</span>

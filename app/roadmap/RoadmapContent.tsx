...
const phases = [
  {
    ...
    title: "E-réputation + Gestion CA/dépenses + Fiches techniques + Food cost + Planning + Costs Bar",
    desc: "Réponses automatiques aux avis Google, TripAdvisor, Booking. Gestion CA et dépenses (4 catégories). Fiches techniques recettes et cocktails. Food cost automatisé et ratios. Planning drag & drop 3 pôles. Costs Bar avec pertes intégrées.",
    ...
    modules: [
      ...
      "Dashboard CA et dépenses en 4 catégories",
      "Fiches techniques recettes avec 14 allergènes",
      "Food cost automatisé par plat",
      "Planning drag & drop 3 pôles (Salle/Bar/Cuisine)",
      "Costs Bar avec calcul des pertes",
